...
const initializeGLB = (
    ...
    // glb_dispatcher: [boolean, React.Dispatch<any>]
) => {
...
const initializeScene = (
    ...
    setText_update: React.Dispatch<React.SetStateAction<boolean>>,
    updated_text: string,
    text_update: boolean,
...
const CanvasComponent = () => {
    ...
    useEffect(() => {
        ...
        if (canvas) {
            return initializeScene(canvas, sceneRef, animationRef, dispatchers, glb_dispatcher, setText_update, updated_text, text_update, meshes_amount)
        }
    }, [])

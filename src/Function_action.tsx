                ...
                if (pointerInfo.pickInfo.pickedMesh?.name.startsWith("hitBox_animation")) {
                    ...
                    dispatch({
                        ...
                        open: () => {
                            ...
                            setTimeout(() => { glb_animation[8]?.current?.start(true) }, 1000)
                            setTimeout(() => { glb_animation[7]?.current?.stop() }, 1000)
                            setTimeout(() => { glb_animation[2]?.current?.start(true) }, 1000)
                            glb_animation[3].current?.stop()
                            glb_animation[0].current?.start(true)
                        },
                        close: () => {
                            ...
                            glb_animation[8].current?.stop()
                            setTimeout(() => { glb_animation[3]?.current?.start(true) }, 1000)
                            glb_animation[2].current?.stop()
                        }
                    })
                }
            }

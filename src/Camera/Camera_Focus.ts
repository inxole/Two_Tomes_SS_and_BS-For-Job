...
const mobil_Tome_SS_ClosePosition = new Vector3(0, -0.18, -3.5)
const mobil_Tome_SS_OpenPosition = new Vector3(-0.115981, -0.18, -3.5)

const mobile_Tome_BS_CloseTarget = new Vector3(0, 0.18, 0)
const mobile_Tome_BS_OpenTarget = new Vector3(-0.115981, 0.18, 0)
const mobile_Tome_SS_CloseTarget = new Vector3(0, -0.18, 0)
const mobile_Tome_SS_OpenTarget = new Vector3(-0.115981, -0.18, 0)
...
function FocusOnBS(OpenUp: boolean, usedMobile: boolean) {
    ...
    if (usedMobile) {
        ...
        A_Camera.camera.setTarget(OpenUp ? mobile_Tome_BS_OpenTarget : mobile_Tome_BS_CloseTarget)
    } else {
...
function FocusOnSS(OpenUp: boolean, usedMobile: boolean) {
    ...
    if (usedMobile) {
        ...
        A_Camera.camera.setTarget(OpenUp ? mobile_Tome_SS_OpenTarget : mobile_Tome_SS_CloseTarget)
    } else {
